...
export default function BootcampCertificates() {
  ...
  return (
    <div className="relative z-10 min-h-screen flex flex-col">
      ...
      <main className="flex-grow px-6 py-10 relative z-10">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Bootcamp Certificates</h1>
          ...
          {certificates.length === 0 ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              {certificates.map((cert, index) => (
                <div key={index} className="glass-card p-6 rounded-2xl border border-white/10 hover:border-purple-500/50 transition-all bg-white/5 group">
                  <div
                  ...
                  <div className="flex flex-col gap-2">
                    <button
                      onClick={() => openModal(cert.image)}
                      className="inline-flex items-center gap-1 text-purple-400 text-sm font-bold hover:gap-2 transition-all focus:outline-none w-fit"
                    >
